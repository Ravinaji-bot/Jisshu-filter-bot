...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1834715690 6703043821').split()]
USERNAME = environ.get('USERNAME', "https://t.me/JackSaparrow23") # ADMIN USERNAME
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003050861330'))  # set shortner log channel
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002857939262')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-4981673781'))
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/7912e110cb255bc7af4dd-c03d1063b55c092fce.jpg'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
